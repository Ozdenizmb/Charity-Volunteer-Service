...
public interface ApplicationApi {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Boolean.class))),
            @ApiResponse(responseCode = "201", description = "Created", content = @Content(schema = @Schema(implementation = ApplicationCreateDto.class))),
    ...
    ResponseEntity<UUID> createApplication(@RequestBody @Valid ApplicationCreateDto applicationCreateDto);
