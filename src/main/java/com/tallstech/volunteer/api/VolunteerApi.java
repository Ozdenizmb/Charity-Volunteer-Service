...
public interface VolunteerApi {
    ...
    @Operation(operationId = "createVolunteer", summary = "Create volunteer.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Boolean.class))),
            @ApiResponse(responseCode = "201", description = "Created", content = @Content(schema = @Schema(implementation = VolunteerCreateDto.class))),
    ...
    ResponseEntity<UUID> createVolunteer(@RequestBody @Valid VolunteerCreateDto volunteerCreateDto);

    @Operation(operationId = "getVolunteer", summary = "Get volunteer by id.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = VolunteerDto.class))),
            @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "404", description = "Not Found", content = @Content(schema = @Schema(implementation = Error.class))),
    ...
    ResponseEntity<VolunteerDto> getVolunteerById(@PathVariable UUID id);
